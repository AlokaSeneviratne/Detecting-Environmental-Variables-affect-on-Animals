...
#define servername "research" //Define the name to your server... 
...
void setup() {
  ...
  Serial.println("HTTP server started");
    ...
    appendFile(SD, "/data.csv", "Humidity,Temperature,Heat index,Moisture value,Pressure,Time\n");
}
...
void loop() {
  ...
  data = String(h)+(",")+String(t)+(",")+String(hic)+(",")+String(value)+(",")+String(bmp.readPressure())+(",")+String(now.hour(), DEC)+(":")+String(now.minute(), DEC)+(":")+String(now.second(), DEC)+("-")+String(daysOfTheWeek[now.dayOfTheWeek()])+("-")+String(now.day(), DEC)+("-")+String(now.month(), DEC)+("-")+String(now.year(), DEC)+"\n";
  Serial.println(data);
